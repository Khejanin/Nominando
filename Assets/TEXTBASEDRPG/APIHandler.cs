...
public class APIHandler : MonoBehaviour
{
    ...
    private IEnumerator uploadText(string text)
    {
        ...
        UnityWebRequest request = UnityWebRequest.Post(ip+"/text",UnityWebRequest.kHttpVerbPOST);
        UploadHandlerRaw uH= new UploadHandlerRaw(bytes);
    ...
    private IEnumerator uploadProgress()
    {
        ...
        progressJson.progress = Game.progress;
        
        string data = JsonConvert.SerializeObject(progressJson);

        byte[] bytes = Encoding.ASCII.GetBytes(data);
            
        UnityWebRequest request = UnityWebRequest.Post(ip+"/updateProgress",UnityWebRequest.kHttpVerbPOST);
    ...
    public partial class ServerData
    {
      ...
      [JsonProperty("progressIndex")] public int progressIndex;
