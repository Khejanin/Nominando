	...
	public class LeanSelectionManager_Inspector : LeanInspector<LeanSelectionManager>
	{
		protected override void DrawInspector()
		{
			...
			EditorGUI.BeginDisabledGroup(true);
				EditorGUILayout.ObjectField("Current Selectable", UnityEngine.EventSystems.EventSystem.current != null ? UnityEngine.EventSystems.EventSystem.current.currentSelectedGameObject : null, typeof(GameObject), false);
