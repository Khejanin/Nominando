...
namespace Lean.Gui
{
	...
	public class LeanDrag : Selectable, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		public LeanDragToTarget hoverOverObject;
		private LeanDragToTarget oldHoverOverObject;
		...
		public void OnBeginDrag(PointerEventData eventData)
		{
			...
			if(hoverOverObject) hoverOverObject.isOccupied = false;
		...
		public void OnEndDrag(PointerEventData eventData)
		{
			...
			if (hoverOverObject == null)
			{
				...
				if(hoverOverObject && hoverOverObject.canOnlyHoldOne) hoverOverObject.isOccupied = true;
			}
			else
			{
				...
				if(hoverOverObject.canOnlyHoldOne) hoverOverObject.isOccupied = true;
			}
		...
		private void OnTriggerExit2D(Collider2D other)
		{
			if (other.gameObject.CompareTag("DragBox"))
			{
				...
				if (hover != null && hover.GetComponent<LeanDragToTarget>() == hoverOverObject) hoverOverObject = null;
			}
		}
